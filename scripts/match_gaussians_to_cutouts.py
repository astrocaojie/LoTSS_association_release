...
from lofar_det_vsex.segmentation import build_snr_map, segment_snr_map
...
def main() -> None:
    ...
    write_dataframe(out, out_dir / "lofar_det_vsex_components.parquet")
    out.to_csv(out_dir / "lofar_det_vsex_components.csv", index=False)
